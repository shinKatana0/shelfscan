...
> **`doc/guide.md` の翻訳。** Translated from `0b15a68` (2026-08-22).
> 英語の原文が先に進んでいないかは、次の一行で確認できます:
> `git log --oneline 0b15a68..HEAD -- doc/guide.md` — 出力が空なら、この翻訳は
...
規模の目安として、開発中に計測した実在の棚では、およそ六行に一行の割合で IGDB の ID がありませんでした。
