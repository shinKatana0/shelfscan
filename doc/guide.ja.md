...
> 進んでおり、最後に動かしたのは `320d157` です (2026-08-23)。**
...
> 二つから三つに増えたこと――と、T-0306 が直した内容――今日 TMDB を呼ぶ
> 実行は一つもなく、どちらのシェルもそのクライアントを接続していないため、
> IGDB の資格情報があるときには映画の行がゲームのカタログで検索され、
> ゲームに一致して返ってくることがあること、および確認画面で種別を直しても
> 検索はやり直されないこと――を含んでいません。
